...
- [ ] **Step 2: 运行 RagService 测试并确认 RED**
...
- [ ] **Step 4: 运行 RagService 测试并确认 GREEN**

Run: `Set-Location backend; uv run pytest tests/unit/test_rag_service.py -q`

Expected: PASS。

- [ ] **Step 5: 写流式拒答和依赖接线失败测试**
