...
- Modify: `docs/实施计划/2026-07-15-阶段3C1重排序验收门禁.md`
...
`docs/实施计划/阶段3执行进度.md` 新增“3C.1 生产安全增强”记录，写入真实测试数量、校准约束、推荐阈值、固定 30 条指标和性能。3C 原 Task 5 只在原 MRR 门真实通过时勾选；否则继续保持 3D 阻塞。
...
```powershell
git add README.md docs/实施计划/阶段3执行进度.md docs/实施计划/2026-07-15-阶段3C1重排序验收门禁.md
