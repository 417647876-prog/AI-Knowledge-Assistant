...
- Create: `docs/验收与演示/阶段2C验证与演示.md`
...
`docs/验收与演示/阶段2C验证与演示.md` 至少包含：环境准备、数据库迁移、前后端启动、自动测试、浏览器演示、权限 404 验证、删除后问答验证和已知边界。
...
git diff --check
git status --short
git add README.md frontend/README.md docs/验收与演示/阶段2C验证与演示.md docs/实施计划/2026-07-14-阶段2C文档管理.md
